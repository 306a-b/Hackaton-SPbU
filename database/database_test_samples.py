...
db.session.add(Offer('К-Руока',
                     ...
                     'http://www.k-ruoka.ru/',
                     'магазин, продукты, супермаркет, финский'))
db.session.add(Offer('Говно с дымом',
                     ...
                     'http://fbi.com',
                     'бухло, кальян, содомия, современное искусство'))
db.session.add(Offer('Банкомат Сбербанк', 'ПН,ВТ,СР,ЧТ,ПТ,СБ,ВС|00:00-00:00|\n', d[2], 'Банкомат',
                     {'lat': 29.827311, 'lng': 59.8737107}, 'https://sberbank.ru', 'банкомат, сбербанк, безнал, снять деньги, карта'))

db.session.add(Offer('Герард Миллер', 'ПН,ВТ,СР,ЧТ,ПТ,СБ,ВС|10:00-22:00|', d[0], 'вкусная шавуха',
                     {'lng': 59.8748755, 'lat': 29.8265393}, '', 'шаверма шавуха еда пицца поесть кафе столовая паста'))
